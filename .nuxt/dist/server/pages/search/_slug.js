...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/search/_slug.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({
  head() {
    return {
      ...
      meta: [{
        ...
        name: 'Android private server download ' + this.$route.params.slug + ', download dragonnest private server' + this.year,
        content: 'Android private server download ' + this.$route.params.slug + ', download dragonnest private server' + this.year
      }]
    };
  },
  ...
  methods: {
    async getFetchApk() {
      const response = await this.$axios.get("applications" + `?Title_contains=` + this.$route.params.slug + `&_limit=8`);
    ...
    getNextFetch() {
      ...
      window.onscroll = () => {
        ...
        if (bottomOfWindow) {
          ...
          this.$axios.get("applications" + `?Title_contains=` + this.$route.params.slug + `&_start=` + page + `&_limit=8`).then(response => {
...
// CONCATENATED MODULE: ./pages/search/_slug.vue?vue&type=script&lang=js&
 /* harmony default export */ var search_slugvue_type_script_lang_js_ = (_slugvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/search/_slug.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  search_slugvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
